  ...
  return (
    <main className="md:ml-[280px] ml-0">
        ...
        <div className="grid grid-flow-col auto-cols-max drop-shadow overflow-x-auto md:px-4">
          {Object.keys(TABS).map((item, index) => (
            <button key={index} className="bg-white border-x-[0.5px] border-y py-2 px-4">
              <span className="text-gray-700">{TABS[item]}</span>
            </button>
          ))}
        </div>
      </div>
            ...
            <div className="grid ml-0  md:w-4/5">
              ...
              <div className="flex items-start">
                ...
                <div className="grid mb-5">
                  ...
                  <div className="mt-1 relative text-gray-500 focus-within:text-gray-400 border-gray-300">
                    ...
                    <input
                      type="search"
                      name="q"
                      className="py-1 text-base border text-gray-900 border-gray-300 bg-white rounded-lg pl-10 pr-1 focus:outline-none focus:text-gray-900"
      ...
      <div className="billing-history">
        <div className="flex flex-col md:flex-row justify-between px-4 mb-5 md:items-center">
          <h3 className="text-gray-900 text-lg font-medium">Billing History</h3>
          <button className="max-w-[146px] md:mt-0 mt-2 border border-[#D0D5DD] bg-white flex rounded-lg px-4 py-3 items-center">
            <>
              <img src="../download-icon.png" />
              <span className="ml-2 text-gray-700 text-sm">Download all</span>
            </>
          </button>
        </div>
        <div>
